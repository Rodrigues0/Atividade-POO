...
public class Exercicio10a15 {
    public static void main(String[] args) {
        ...
        Cliente cliente1 = new Cliente("Martha","martha@gmail.com", "97687-8765");
        Cliente cliente2 = new Cliente ("Bruno", "bruno@gmail.com", "965472154");
        Cliente cliente3 = new Cliente ("Yasmin", "yasmin@outlook.com", "941526874");

        cliente1.exibir();
        cliente2.exibir();
        cliente3.exibir();
        System.out.println("Total de Cliente: " + Cliente.totalClientes);
        ...
        do {
            ...
            System.out.println("3 - Total Cadastrados");
            ...
            switch (escolha) {
                case 1:
                    CadastrarCarro(sc, listaCarro);
                    break;

               case 2:
                    MostrarCarros(listaCarro);
                    break;

                case 3:
                    TotalCarros(listaCarro);
                    break;
        ...
        public static void CadastrarCarro(Scanner sc, ArrayList<Carro> listaCarro){
            ...
            System.out.println("Insira o ano do Véiculo: ");
            carro1.setAno(sc.nextInt());
            listaCarro.add(carro1);
        }

        public static void MostrarCarros(ArrayList<Carro> listaCarro){
    ...
    public static void TotalCarros(ArrayList<Carro> listaCarro){
        System.out.println("Total de Carros: " + Carro.totalCarro);
    }
